...
namespace Library_System_Project_Core.Controllers.LibraryManagement
{
    public class PublishersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PublisherID,Name,Establish_Date,Address")] Publisher publisher)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PublisherID,Name,Establish_Date,Address")] Publisher publisher)
        {
